...
//            .shareReplay(1)
        ...
        cityName = Variable("").asObservable()//weather
//            .map { $0.cityName ?? "" }
//        
        temp = Variable("").asObservable()//temp//weather
//            .map { "\($0.currentWeather.temp)" }
//        
        weatherDescription = Variable("").asObservable()//weather
//            .map { $0.currentWeather.description }
//        
//        weatherImageData = Variable("").asObservable()//weather
//            .map { $0.currentWeather.imageID }
//            .flatMap(weatherService.weatherImage)
//        
//        weatherBackgroundImage = nil //Variable("").asObservable()//weather
//            .map { $0.currentWeather.imageID }

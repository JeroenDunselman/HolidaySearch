...
extension CalendarView: NameDayView {
...
//  }
  ...
  func setNameDayEvents(_ celebrations: [NameDayViewData]) {
    nameDayEvents = celebrations
//    self.calendarView.reloadData()
    //    celebrationsToDisplay
...
//  fileprivate var nameDayEvents : [NameDayViewData] = [NameDayViewData]()
...
//        }
        ...
        let startDate = event.date.addingTimeInterval(secondsFromGMTDifference)
        let endDate = event.date.addingTimeInterval(secondsFromGMTDifference).addingTimeInterval(secondsFromGMTDifference)
        ...
        let calEvent = CalendarEvent(title: event.celebration.title, startDate: startDate, endDate: endDate)

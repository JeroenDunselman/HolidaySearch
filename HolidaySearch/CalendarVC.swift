...
class CalendarVC: UIViewController, CalendarViewDataSource, CalendarViewDelegate {
    ...
    fileprivate let nameDayPresenter = NameDayPresenter(celebrationService: CelebrationService())

    override func viewDidLoad() {
        
        super.viewDidLoad()
      //todo:
//      nameDayPresenter.attachCalendarView(calendarView)
        nameDayPresenter.getNameDays()
